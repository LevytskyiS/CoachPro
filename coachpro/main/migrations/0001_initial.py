# Generated by Django 5.0 on 2024-01-06 16:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lifestyle', models.CharField(choices=[('Active', 'Active'), ('Passive', 'Passive')], max_length=7, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sleep_quality', models.CharField(choices=[('Good', 'Good'), ('Bad', 'Bad')], max_length=4, null=True)),
                ('mood', models.CharField(choices=[('Good', 'Good'), ('Bad', 'Bad')], max_length=4, null=True)),
